...
namespace Spectrum.UITest.POPBases
{
    ...
    {
        const string ApkPath = "../../../../../Spectrum.Droid/bin/Release/com.charter.spectrum.login.apk";
        ...
        public static void StartApp()
        {
            if (Platform == Platform.Android)
            {
                app = ConfigureApp
                    ...
                    .ApkFile(TestUtils.GetApkDirectory(ApkPath))
                    .StartApp();
            }
            ...
            if (Platform == Platform.iOS)
            {
                app = ConfigureApp
                    ...
                    .AppBundle(TestUtils.GetApkDirectory(AppPath))
